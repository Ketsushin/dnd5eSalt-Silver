...
export default class DamageRollConfigurationDialog extends RollConfigurationDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    formulas: {
      template: "systems/ketsushin-salt-silver/templates/dice/damage-formulas.hbs"
    }
  };
