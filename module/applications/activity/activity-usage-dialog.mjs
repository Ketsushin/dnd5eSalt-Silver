...
export default class ActivityUsageDialog extends Dialog5e {
  ...
  static PARTS = {
    scaling: {
      template: "systems/ketsushin-salt-silver/templates/activity/activity-usage-scaling.hbs"
    },
    concentration: {
      template: "systems/ketsushin-salt-silver/templates/activity/activity-usage-concentration.hbs"
    },
    consumption: {
      template: "systems/ketsushin-salt-silver/templates/activity/activity-usage-consumption.hbs"
    },
    creation: {
      template: "systems/ketsushin-salt-silver/templates/activity/activity-usage-creation.hbs"
    },
    footer: {
