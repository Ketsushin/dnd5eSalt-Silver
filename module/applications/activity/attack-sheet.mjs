...
export default class AttackSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    identity: {
      template: "systems/ketsushin-salt-silver/templates/activity/attack-identity.hbs",
      templates: [
        ...super.PARTS.identity.templates,
        "systems/ketsushin-salt-silver/templates/activity/parts/attack-identity.hbs"
      ]
    },
    effect: {
      template: "systems/ketsushin-salt-silver/templates/activity/attack-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/ketsushin-salt-silver/templates/activity/parts/attack-damage.hbs",
        "systems/ketsushin-salt-silver/templates/activity/parts/attack-details.hbs",
