...
export default class SaveSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/ketsushin-salt-silver/templates/activity/save-effect.hbs",
      templates: [
        ...
        "systems/ketsushin-salt-silver/templates/activity/parts/save-damage.hbs",
        "systems/ketsushin-salt-silver/templates/activity/parts/save-details.hbs",
        "systems/ketsushin-salt-silver/templates/activity/parts/save-effect-settings.hbs"
      ]
    }
  };
  ...
  _prepareAppliedEffectContext(context, effect) {
    effect.additionalSettings = "systems/ketsushin-salt-silver/templates/activity/parts/save-effect-settings.hbs";
    return effect;
  }
