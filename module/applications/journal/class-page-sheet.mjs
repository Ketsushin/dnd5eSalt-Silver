...
export default class JournalClassPageSheet extends JournalEntryPageHandlebarsSheet {
  ...
  static EDIT_PARTS = {
    ...
    config: {
      ...
      template: "systems/ketsushin-salt-silver/templates/journal/page-{type}-edit.hbs"
    }
  };
  ...
  static VIEW_PARTS = {
    content: {
      root: true,
      template: "systems/ketsushin-salt-silver/templates/journal/page-{type}-view.hbs"
    }
  };
