...
export default class Award extends Application5e {
  ...
  static PARTS = {
    award: {
      template: "systems/ketsushin-salt-silver/templates/apps/award.hbs"
    }
  };
  ...
  static prepareDestinations(destinations, savedDestinations) {
    const icons = {
      container: '<dnd5e-icon class="fa-fw" src="systems/ketsushin-salt-silver/icons/svg/backpack.svg"></dnd5e-icon>',
