...
export default class CurrencyManager extends Application5e {
  ...
  static PARTS = {
    ...
    convert: {
      template: "systems/ketsushin-salt-silver/templates/apps/currency-manager-convert.hbs"
    },
    transfer: {
      template: "systems/ketsushin-salt-silver/templates/apps/currency-manager-transfer.hbs"
    }
  };
