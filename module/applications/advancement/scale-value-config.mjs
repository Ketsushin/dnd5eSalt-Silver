...
export default class ScaleValueConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...
    details: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/ketsushin-salt-silver/templates/advancement/scale-value-config-details.hbs"
    },
    levels: {
      container: { classes: ["column-container"], id: "column-right" },
      template: "systems/ketsushin-salt-silver/templates/advancement/scale-value-config-levels.hbs"
    }
  };
