...
export default class AbilityScoreImprovementConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/ketsushin-salt-silver/templates/advancement/ability-score-improvement-config-details.hbs"
    },
    scores: {
      template: "systems/ketsushin-salt-silver/templates/advancement/ability-score-improvement-config-scores.hbs",
      templates: ["systems/ketsushin-salt-silver/templates/advancement/parts/advancement-ability-score-control.hbs"]
    }
  };
