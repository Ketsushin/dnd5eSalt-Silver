...
export default class EncounterActorSheet extends MultiActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/ketsushin-salt-silver/templates/actors/encounter/header.hbs"
    },
    tabs: {
    ...
    members: {
      ...
      template: "systems/ketsushin-salt-silver/templates/actors/encounter/members.hbs",
      scrollable: [""]
    },
    inventory: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/actor-inventory.hbs",
      templates: ["systems/ketsushin-salt-silver/templates/inventory/inventory.hbs"],
      scrollable: [""]
    },
    description: {
      container: { classes: ["tab-body"], id: "tabs" },
