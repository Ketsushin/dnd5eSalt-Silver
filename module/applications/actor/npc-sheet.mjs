...
export default class NPCActorSheet extends BaseActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/ketsushin-salt-silver/templates/actors/npc-header.hbs"
    },
    sidebarCollapser: {
    ...
    sidebar: {
      container: { classes: ["main-content"], id: "main" },
      template: "systems/ketsushin-salt-silver/templates/actors/npc-sidebar.hbs"
    },
    features: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/actor-features.hbs",
    ...
    inventory: {
      ...
      templates: [
        ...
        "systems/ketsushin-salt-silver/templates/inventory/encumbrance.hbs"
      ],
      scrollable: [""]
    },
    spells: {
    ...
    biography: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/npc-biography.hbs",
      scrollable: [""]
    },
    specialTraits: {
      classes: ["flexcol"],
