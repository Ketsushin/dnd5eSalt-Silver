...
export default class CharacterActorSheet extends BaseActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/ketsushin-salt-silver/templates/actors/character-header.hbs"
    },
    sidebar: {
      container: { classes: ["main-content"], id: "main" },
      template: "systems/ketsushin-salt-silver/templates/actors/character-sidebar.hbs"
    },
    details: {
      classes: ["col-2"],
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/character-details.hbs",
      scrollable: [""]
    },
    inventory: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/character-inventory.hbs",
      templates: [
        ...
        "systems/ketsushin-salt-silver/templates/inventory/encumbrance.hbs", "systems/ketsushin-salt-silver/templates/inventory/containers.hbs"
      ],
      scrollable: [""]
    },
    features: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/character-features.hbs",
    ...
    spells: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/creature-spells.hbs",
      templates: ["systems/ketsushin-salt-silver/templates/inventory/inventory.hbs", "systems/ketsushin-salt-silver/templates/inventory/activity.hbs"],
      scrollable: [""]
    },
    effects: {
    ...
    biography: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/character-biography.hbs",
      scrollable: [""]
    },
    bastion: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/character-bastion.hbs",
      scrollable: [""]
    },
    specialTraits: {
      classes: ["flexcol"],
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/ketsushin-salt-silver/templates/actors/tabs/creature-special-traits.hbs",
      scrollable: [""]
    },
    abilityScores: {
      template: "systems/ketsushin-salt-silver/templates/actors/character-ability-scores.hbs"
    },
    warnings: {
      template: "systems/ketsushin-salt-silver/templates/actors/parts/actor-warnings-dialog.hbs"
    },
    tabs: {
      id: "tabs",
      classes: ["tabs-right"],
  ...
  static TABS = [
    ...
    { tab: "inventory", label: "DND5E.Inventory", svg: "systems/ketsushin-salt-silver/icons/svg/backpack.svg" },
