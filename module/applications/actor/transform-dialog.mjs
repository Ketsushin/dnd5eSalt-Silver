...
export default class TransformDialog extends Dialog5e {
  ...
  static PARTS = {
    details: {
      template: "systems/ketsushin-salt-silver/templates/apps/transform-details.hbs"
    },
    presets: {
      container: { id: "settings-area" },
      template: "systems/ketsushin-salt-silver/templates/apps/transform-presets.hbs"
    },
    settings: {
      container: { id: "settings-area" },
      template: "systems/ketsushin-salt-silver/templates/apps/transform-settings.hbs"
    },
    footer: {
