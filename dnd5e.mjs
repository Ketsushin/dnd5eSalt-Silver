...
Hooks.once("init", function() {
  ...
  Roll.TOOLTIP_TEMPLATE = "systems/ketsushin-salt-silver/templates/chat/roll-breakdown.hbs";
...
function _configureFonts() {
  Object.assign(CONFIG.fontDefinitions, {
    Roboto: {
      editor: true,
      fonts: [
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto/Roboto-Regular.woff2"] },
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto/Roboto-Bold.woff2"], weight: "bold" },
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto/Roboto-Italic.woff2"], style: "italic" },
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto/Roboto-BoldItalic.woff2"], weight: "bold", style: "italic" }
      ]
    },
    "Roboto Condensed": {
      editor: true,
      fonts: [
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto-condensed/RobotoCondensed-Regular.woff2"] },
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto-condensed/RobotoCondensed-Bold.woff2"], weight: "bold" },
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto-condensed/RobotoCondensed-Italic.woff2"], style: "italic" },
        {
          urls: ["systems/ketsushin-salt-silver/fonts/roboto-condensed/RobotoCondensed-BoldItalic.woff2"], weight: "bold",
          style: "italic"
        }
      ]
    },
    "Roboto Slab": {
      editor: true,
      fonts: [
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto-slab/RobotoSlab-Regular.ttf"] },
        { urls: ["systems/ketsushin-salt-silver/fonts/roboto-slab/RobotoSlab-Bold.ttf"], weight: "bold" }
      ]
    }
  });
}
...
Hooks.on("renderGamePause", (app, html) => {
  ...
  img.src = "systems/ketsushin-salt-silver/ui/official/ampersand.svg";
  img.className = "";
});
